...
const sheetVariants = cva(
  'fixed z-50 grid gap-4 border border-border/70 bg-card p-6 shadow-panel duration-200',
  {
    variants: {
      side: {
...
function SheetHeader({
  ...
  return <div className={cn('flex flex-col space-y-2 pr-10 text-left', className)} {...props} />;
}
